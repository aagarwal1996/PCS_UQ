...
def agg_results_dataset_method(
    ...
    for seed in SEEDS:
        try:
            ...
            print(
                f"Error in loading results for dataset {dataset_name}, seed {seed}, uq_method {uq_method}, estimator {estimator}"
            )
            pass
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--task", type=str, default="classification", help="Task to run"
    )
